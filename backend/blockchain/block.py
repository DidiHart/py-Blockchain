...
class Block:
    ...
    This stores transactions in a blockchain that supports cryptocurrency
    '''
    ...
    def __eq__(self, other):
         # python can't do comparison on classes. break it down under the hood
         # to compare the other dictionary representation
         # dict to dict
    ...
    def mine_block( last_block, data):
        '''
        Mines a block based on last_block and data until a block hash is found
